...
Las Figuras \ref{fig:clases-seccion-1}, \ref{fig:clases-seccion-2} y \ref{fig:clases-seccion-3} dividen el diagrama de clases en secciones para mejorar la legibilidad.
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{Figuras/Diagrama_Clases_seccion3.png}
