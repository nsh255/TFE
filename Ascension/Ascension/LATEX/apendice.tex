...
Además, se proporciona un enlace al repositorio de GitHub donde se encuentra el código fuente completo del videojuego: \url{https://github.com/nsh255/TFE.git}
...
\subsection{Diagrama de clases por secciones}

Las Figuras \ref{fig:clases-seccion-1}--\ref{fig:clases-seccion-3} dividen el diagrama de clases en secciones para mejorar la legibilidad.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.9\textheight,keepaspectratio]{Figuras/Diagrama_Clases_seccion1.png}
    \caption{Diagrama de clases del sistema (sección 1: interfaz de usuario, jugador y armas)}
    \label{fig:clases-seccion-1}
\end{figure}
\clearpage

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.9\textheight,keepaspectratio]{Figuras/Diagrama_Clases_seccion2.png}
    \caption{Diagrama de clases del sistema (sección 2: gestión de juego, eventos y enemigos)}
    \label{fig:clases-seccion-2}
\end{figure}
\clearpage

\begin{figure}[H]
    \centering
    \includegraphics[height=0.85\textheight,keepaspectratio]{Figuras/Diagrama_Clases_seccion3.png}
    \caption{Diagrama de clases del sistema (sección 3: generación procedural y efectos de tiles)}
    \label{fig:clases-seccion-3}
\end{figure}
\clearpage
