...
\begin{itemize}
    \item \textbf{Assets/Scripts}: lógica principal del juego en C\#, organizada por subsistemas (Core, Player, Enemies, Weapons, UI, Tiles y LevelGeneration).
    \item \textbf{Assets/Prefabs}: objetos reutilizables del juego (jugador, enemigos, armas, escaleras y elementos de sala).
    \item \textbf{Assets/Scenes}: escenas del flujo completo (menú principal, selección de clase y escena principal de juego).
    \item \textbf{Docs/Definitivo/Diagramas}: fuentes PlantUML de los diagramas técnicos utilizados en la memoria.
    \item \textbf{LATEX}: memoria final, bibliografía y figuras integradas para compilación del documento.
\end{itemize}
