...
Fase 1: Exploración inicial y definición de alcance (meses 1–3)
...
Como resultado de esta fase se decidió redefinir el enfoque del TFG hacia el desarrollo de un videojuego del subgénero rogue-like, al considerarse un dominio adecuado para aplicar conocimientos de ingeniería del software.

Fase 2: Diseño conceptual y arquitectura base (meses 4–6)
...
Se tomaron decisiones clave relativas al uso de ScriptableObjects, patrones de diseño y separación entre lógica y datos.

Fase 3: Implementación progresiva del núcleo del juego (meses 7–11)
...
Sistema de jefes y condición de victoria
...
Fase 4: Herramientas de editor y mejora de productividad (meses 10–13)

De forma paralela a la implementación del juego, se desarrollaron herramientas específicas dentro del editor de Unity con el objetivo de automatizar tareas repetitivas y facilitar la creación y validación de contenido.
...
Fase 5: Refinamiento, pruebas y documentación (meses 14–15)
...
2.2. Representación gráfica de la planificación

La Figura X muestra un diagrama de Gantt que resume la planificación temporal del proyecto y la superposición parcial de las distintas fases.